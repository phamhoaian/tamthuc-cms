<section class="login">
    ...
    <div class="row cf">
        ...
        <div class="form-group">
            <?php echo $this->Form->hidden('goolge_id', array('value' =>  __(!empty($google_info['id']) ? $google_info['id']:''))) ?>
            <div class="input-group">
            <?php echo $this->Form->input('name', array('value' => __(!empty($google_info['name']) ? $google_info['name']:''), 'placeholder' => __('Full name'), 'readonly' => 'readonly', 'class' => 'form-control', 'div' =>false, 'error' =>false)); ?>
            </div>
            <?php echo $this->Form->error('name') ?>
        </div>
        <div class="form-group">
            <div class="input-group">
            <?php echo $this->Form->input('email', array('value' => __(!empty($google_info['email']) ? $google_info['email']:''), 'placeholder' => __('メールアドレス'), 'readonly' => 'readonly', 'class' => 'form-control', 'div' =>false, 'error' =>false)) ?>
            </div>
        ...
        <div class="form-group">
            <div class="input-group">
            <?php echo $this->Form->input('password', array('placeholder' => __('パスワード'), 'value' => '', 'class' => 'form-control', 'div' =>false, 'error' =>false)); ?>
            </div>
            <?php echo $this->Form->error('password') ?>
        </div>
        <div class="form-group">
            <div class="input-group">
            <?php echo $this->Form->input('password2',array('placeholder' => __('パスワード（確認）'), 'value' => '', 'type' => 'password', 'class' => 'form-control', 'div' =>false, 'error' =>false))?>
            </div>
