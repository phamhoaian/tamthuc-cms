    ...
    <div class="row cf">
        ...
        <div class="form-group">
            <div class="input-group">
                <?php echo $this->Form->input('name', array('value' => __(!empty($twitter_info->name) ? $twitter_info->name:''), 'readonly' => 'readonly', 'class' => 'form-control', 'div' =>false, 'error' =>false)); ?>
            </div>
            <?php echo $this->Form->error('name') ?>
        </div>
        <div class="form-group">
            <div class="input-group">
            <?php echo $this->Form->input('email', array('placeholder' => __('メールアドレス'), 'class' => 'form-control', 'div' =>false, 'error' =>false)); ?>
            </div>
