...
class ColorHelper extends AppHelper
{
    ...
    /**
     * 16<?php echo __('進数のカラーを明るくする（暗くもできる）'); ?>
     * @param int   $color
    ...
    /**
     * bright<?php echo __('は明るいと'); ?>bright<?php echo __('で逆に暗くなるようになっているが、これは明るくなる'); ?>
     * @param $color
     * @param $bright_per
     * @return int $color
     */
    ...
    /**
     * #ffffff<?php echo __('を'); ?>255,255,255<?php echo __('にして返す関数'); ?>
     */
