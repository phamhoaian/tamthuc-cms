...
class UserHelper extends AppHelper
{
    ...
    public function get_user_img_md_from_user_id($user_id, $w = 48)
    {
        ...
        if(!empty($files[0])){
            ...
            return $this->Html->image('user.svg', array(
     ...
     * img項目がないuserでOK牧場。user_idと')facebook_idしか使わないから
     */
    ...
    /**
     * 48*48　プロフィール画像取得'); ?>
     * <?php echo __('引数'); ?>$w<?php echo __('に'); ?>48<?php echo __('以外を渡すと、そのサイズの正方形で表示いたします'); ?>
     */
