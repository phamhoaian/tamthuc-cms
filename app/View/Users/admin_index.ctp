    ...
    <div class="row-fluid">
        ...
        <table class="table">
            <tr>
                ...
                <th><?php echo $this->Paginator->sort('nick_name', __('ニックネーム')); ?></th>
                <th><?php echo $this->Paginator->sort('name', __('名前')); ?></th>
                <th><?php echo $this->Paginator->sort('email', __('メールアドレス')); ?></th>
