...
<h4><span class="el-icon-user"></span> <?php echo __('プロフィール編集'); ?></h4>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <?php echo $this->Form->input('img', array(
                        'type' => 'file', 'label' => __('プロフィール画像'), 'class' => 'client_resize',
            ...
            <div class="form-group">
                <?php echo $this->Form->input('nick_name', array('label' => __('ニックネーム'))); ?>
            </div>

            <div class="form-group">
                <?php echo $this->Form->input('name', array('label' => __('氏名'))); ?>
            </div>

            <div class="form-group">
                <?php echo $this->Form->input('email', array('label' => __('メールアドレス'))); ?>
            </div>

            <div class="form-group">
                <?php echo $this->Form->input('address', array('label' => __('住まい'))); ?>
            </div>
        </div>

        <div class="col-md-6">
            <div class="form-group">
                <?php echo $this->Form->input('self_description', array('label' => __('自己紹介'))); ?>
            </div>
            ...
            <div class="form-group">
                <?php echo $this->Form->input('receive_address', array('label' => __('リターン先住所'))); ?>
            </div>
        </div>
        <div class="col-xs-6 col-xs-offset-3">
            ...
            <input type="submit"
                   ...
                   class="btn btn-primary btn-block" value="<?php echo __('更新'); ?>">
            <br>
        </div>
